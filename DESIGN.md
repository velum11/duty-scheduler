...
- **밀도 정량 게이트(§0.6 잠금값, 1366 기준)**: 조건영역 ≤2행·≤96px / MASTER_DETAIL 편집 상세 ≥600px / 요약·KPI 스트립 한 행 ≤72px / 미선택 안내 ≤72px / above-fold 의미 없는 빈 surface ≤20%·핵심 작업영역 ≥70% / 카드·보더 겹침 0. (사내 실 ERP 화면과의 대조는 선택적 참고 수단이며 목표치가 아닙니다 — 기준은 결과 품질.)
