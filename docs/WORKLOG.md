...
- 잔여: 매핑 미확정 4화면(대시보드·월간 근무표·아차사고 조회·내 근무표 — 0단계 제안 회신 대기), 폰트 self-host(CDN 임시), 레일 배지 데이터원 없음(구조만), 사용자 실브라우저 sign-off. 종전 B안(redesign/near-miss-ui)은 이 브랜치의 base로 흡수됨.
