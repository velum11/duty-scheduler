...
# ---------- (제거됨 2026-08-19) 기준정보 공통 레이아웃 사본 ----------
# 구 _MASTER_CSS·master_screen_head·master_grid_height·master_action_bar·master_count 는
# views/master/ 패키지(동명 정본)와 중복인 **죽은 사본**이었다(호출부 0건 — BACKLOG
# 2026-08-15 '죽은 마스터 스타일 코드'). 고친 줄 알았는데 정본이 아닌 사본을 고치는
# 사고 경로라 제거했다. 기준정보 화면은 views.master 를 임포트한다.
