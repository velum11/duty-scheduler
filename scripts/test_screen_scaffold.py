...
NON_SCREEN_REASONS: dict[str, str] = {
    ...
    "password_change": "비밀번호 강제변경 게이트 — dispatch·app_shell 이전에 렌더되는 "
                       "비업무 화면(네비게이션이 보이면 게이트 우회 경로가 된다)",
...
check(
    ...
    NON_SCREEN == {"__init__", "workspace", "login", "password_change", "near_miss_pdf"}
